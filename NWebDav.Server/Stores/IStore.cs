...
{
    Task<IStoreItem?> GetItemAsync(string path, CancellationToken cancellationToken);
    Task<IStoreCollection?> GetCollectionAsync(string path, CancellationToken cancellationToken);
}
